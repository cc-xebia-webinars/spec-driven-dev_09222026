...
- **FR-004**: System MUST convert line items denominated in EUR or GBP to US dollars using the rate in force on the line item's transaction date before applying any cap.
